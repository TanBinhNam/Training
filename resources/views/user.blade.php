...
<div class="container-fluid p-0">
    ...
    <div class="form-row">
        ...
        <div class='col-md-4 text-right' style="float:right">
            <button class="btn btn-primary ml-5 mr-3 btn-search" form="search"><i class="fa fa-search  mr-2"></i>Tìm kiếm</button>
            <button class="btn btn-success ml-5 btn-reset-search"><i class="fa fa-times  mr-2"></i>Xóa tìm</button>
        </div>
    </div>
